...
class Credit {
  constructor() {
    ...
    __publicField(this, "logoItems");
    __publicField(this, "creditCard");
    ...
    this.init();
    const self2 = this;
    this.creditCard = new Cleave_1(".input-credit", {
      creditCard: true,
      onCreditCardTypeChanged: function(type) {
        console.log(type);
        self2.highlightCreditLogo(type);
      }
    });
    this.expiration = new Cleave_1(".input-expiration", {
      date: true,
      datePattern: ["m", "y"]
    });
    this.security = new Cleave_1(".input-security", {
      numeral: true,
